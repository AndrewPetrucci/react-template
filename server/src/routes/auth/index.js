...
/** GET /api/auth/me - requires optionalAuth so we can return null or user */
router.get('/me', optionalAuth, (req, res) => {
  res.json({ user: req.user })
})

/** POST /api/auth/verify-email — body: { token, newPassword }. Verifies email and sets password; returns user + token. */
...
/** POST /api/auth/test-email — dev only: send a test email to verify SMTP. Body: { email } */
